...
def main():
    ...
    myonTrackbarBmin = partial(onTrackbarBmin, image=image, window_name=window_name, Limites=Limites,
                               trackbar_name_Bmax=trackbar_name_Bmax)
    myonTrackbarBmax = partial(onTrackbarBmax, image=image, window_name=window_name, Limites=Limites,
                               trackbar_name_Bmin=trackbar_name_Bmin)
    myonTrackbarGmin = partial(onTrackbarGmin, image=image, window_name=window_name, Limites=Limites,
                               trackbar_name_Gmax=trackbar_name_Gmax)
    myonTrackbarGmax = partial(onTrackbarGmax, image=image, window_name=window_name, Limites=Limites,
                               trackbar_name_Gmin=trackbar_name_Gmin)
    myonTrackbarRmin = partial(onTrackbarRmin, image=image, window_name=window_name, Limites=Limites,
                               trackbar_name_Rmax=trackbar_name_Rmax)
    myonTrackbarRmax = partial(onTrackbarRmax, image=image, window_name=window_name, Limites=Limites,
